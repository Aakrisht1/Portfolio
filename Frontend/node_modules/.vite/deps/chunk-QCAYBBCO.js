...
import {
  ...
  useTheme_default
} from "./chunk-CSQUW4BI.js";
import {
  require_prop_types
} from "./chunk-GHWL5SUI.js";
import {
  _extends,
  init_extends
} from "./chunk-7CGG54PI.js";
import {
  require_jsx_runtime
...
function RtlProvider(_ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(RtlContext.Provider, _extends({
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const element = (0, import_jsx_runtime15.jsxs)(React17.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime15.jsxs)(React17.Fragment, {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React24.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React24.useEffect(() => {
  ...
  const updateRootElementName = React24.useCallback((instance) => {
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React53.useState(true);
  const hasPendingExitTransition = React53.useRef(false);
  const registeredTransitions = React53.useRef(0);
  const [hasTransition, setHasTransition] = React53.useState(false);
  const previousRequestEnter = React53.useRef(requestEnter);
  React53.useEffect(() => {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React59.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React61.memo(React61.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React61.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var NumberInput = React64.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime36.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime36.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime36.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React65.forwardRef(function OptionGroup2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime39.jsxs)(Root, _extends({}, rootProps, {
    ...
    })), (0, import_jsx_runtime38.jsx)(List, _extends({}, listProps, {
...
var Switch = React75.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime48.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime47.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime47.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime47.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
var TablePagination = React77.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime51.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime52.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime51.jsx)(Select3, _extends({}, selectProps, {
...
"use client";
var _excluded41 = ["action", "children", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots", "value"];
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QCAYBBCO.js.map
